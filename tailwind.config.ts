  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-gold": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(48, 96%, 53%, 0.4), 0 0 40px hsl(48, 96%, 53%, 0.2)",
          },
          "50%": {
            boxShadow: "0 0 35px hsl(48, 96%, 53%, 0.6), 0 0 70px hsl(48, 96%, 53%, 0.3)",
          },
        },
        float: {
      ...
      animation: {
        ...
        "icon-spin": "icon-spin 0.3s ease-out forwards",
      },
    },
  },
