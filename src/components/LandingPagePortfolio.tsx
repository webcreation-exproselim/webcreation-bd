    ...
    >
      ...
      >
        <img
          src={item.image_url}
          alt={item.title}
          className="w-full h-full object-cover transition-all duration-[20000ms] ease-in-out will-change-[object-position]"
          style={{
      ...
      <div className="p-3 sm:p-4">
        <h4 className="text-white font-bengali font-semibold text-sm sm:text-base mb-2 sm:mb-3 group-hover:text-teal-400 transition-colors line-clamp-1">
          {item.title}
        </h4>
