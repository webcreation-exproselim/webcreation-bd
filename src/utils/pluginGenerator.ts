...
class Fraud_Protection_BD {
    ...
    public function check_woocommerce() {
        if (!class_exists('WooCommerce')) {
            add_action('admin_notices', function() {
                echo '<div class="error"><p><strong>Fraud Protection BD</strong> requires WooCommerce.</p></div>';
            });
        }
    }
    ...
    private function get_popup_css() {
        ...
        .fraud-popup-days{font-size:32px;font-weight:700;color:#00d4ff;margin:0 0 24px}
        ...
        (function($) {
            var FP = {
                ...
                validate: function(f) {
                    ...
                    btn.prop('disabled', true).data('txt', btn.text()).html('চেক করা হচ্ছে...');
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                            if (r.allowed) {
                                ...
                                self.popup(r.reason, r.message, r.days_remaining);
                ...
                popup: function(type, msg, days) {
                    ...
                    var html = '<div class=\"fraud-popup-overlay\" id=\"fraudPopup\">' +
                        ...
                        (days ? '<p class=\"fraud-popup-days\">' + days + ' ' + (this.lang === 'bn' ? 'দিন বাকি' : 'days left') + '</p>' : '') +
    ...
    private function get_admin_css() {
        ...
        .fraud-header{background:linear-gradient(135deg,#1a1a2e,#16213e);color:#fff;padding:30px;border-radius:12px;margin-bottom:20px}
        .fraud-header h1{color:#fff;font-size:28px;margin:0 0 10px;display:flex;align-items:center;gap:10px}
        .fraud-header .dashicons{font-size:32px;width:32px;height:32px;color:#00d4ff}
        ...
        .fraud-toggle input:checked+.fraud-toggle-slider{background:#00d4ff}
    ...
    public function render_settings_page() {
        ...
        <div class="wrap fraud-wrap">
            <div class="fraud-header">
                <h1><span class="dashicons dashicons-shield"></span> Fraud Protection BD</h1>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="test-api-btn" class="button">Test</button>
                ...
                <div class="fraud-card">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th>Language</th>
                            <td>
                                <label><input type="radio" name="language" value="bn" <?php checked($language, 'bn'); ?>> বাংলা</label><br>
    ...
    public function test_api_connection() {
        ...
        $response = wp_remote_post($this->endpoint, array(
            ...
            'body' => json_encode(array('api_key' => get_option('fraud_protection_api_key', $this->api_key), 'phone' => '01700000000', 'device_id' => 'test')),
            'timeout' => 15
        ));
...
export const downloadPluginFile = (apiKey: string): void => {
  ...
  a.href = url;
  a.download = 'fraud-protection-bd.php';
